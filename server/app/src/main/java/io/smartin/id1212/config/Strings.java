...
public class Strings {
    ...
    public static final String UNAUTHORIZED_OPEN_TRADE = "You can only trade 1 card openly";
    public static final String NOT_FINAL_TRADE = "You cannot trade openly until the final trade";
